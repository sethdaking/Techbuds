      ...
      <div className="mx-auto flex max-w-6xl flex-col justify-between py-2 font-medium text-black md:flex-row md:items-center">
        <div className="flex items-center justify-between">
          <Link href="/" className="z-30" onClick={() => setOpen(false)}>
            <WordMark />
            <span className="sr-only">TechBuds Solutions Home Page</span>
          </Link>
          <Link href="/products" className="p-10" onClick={() => setOpen(true)}>Products</Link>
          <Link href="/about" className="p-10" onClick={() => setOpen(true)}>About</Link>
